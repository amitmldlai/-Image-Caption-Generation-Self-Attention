...
2) Four different techniques we employed to boost the performance of model:
    Trainable Embedding layer without any pre-initialization of weights
    Bidirectional LSTM with higher number of units to encode the texts input better
    Self-Attention layer to focus on specific part
    Concatenate layer for merging the image and text feature vectors
